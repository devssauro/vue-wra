          ...
          <v-sheet rounded="lg" class="pa-2">
            <v-row :style="{ visibility: isLoading ? 'hidden' : 'visible' }">
                    ...
                    <v-container>
                      <v-row align="start">
                        ...
                        <v-col cols="8" class="py-0">
                          ...
                          <p
                            class="mb-0"
                            v-if="selectedChampionStats !== undefined"
                          >
                            <span>
                              {{ selectedChampionStats.qty_picks }} PICKS
                            </span>
                            <span class="pl-2">
                              {{ selectedChampionStats.qty_bans }} BANS </span
                            ><br />
                            <span>
                              {{ selectedChampionStats.percent_presence }}%
                              PRESENÇA
                            </span>
                          </p>
                        </v-col>
              ...
              <v-col cols="6" sm="6" md="7">
                ...
                >
                  <v-row>
                    <v-col cols="6" class="text-center t">
...
export default {
  ...
  computed: {
    ...
    selectedChampionStats() {
      ...
      return this.championStats.filter(
        (c) => c.champion_id === this.search.champion_id
      )[0];
    },
  },
  methods: {
    ...
    getChampionStats() {
      axios
        .get(`v1/view/stats/champion`, { params: this.search })
        .then((res) => {
    ...
    getTop3() {
      axios
        .get(`v1/view/champion/${this.selectedChampion.id}/top3`, {
          params: this.axiosParams,
        })
        .then((res) => {
