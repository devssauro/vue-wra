            ...
            <v-row>
              <v-col cols="3" sm="12" md="5">
                <v-card
                  ...
                  outlined
                  v-if="
                    search.player_id !== null && search.player_id !== undefined
                  "
                >
                  <v-card-title>
                    <v-container>
...
export default {
  ...
  methods: {
    ...
    championChanged(val) {
      ...
      this.selectedChampion = this.playerChampions.filter(
        (c) => c.name === val
      )[0];
    ...
    getPlayersFromRole() {
      axios
        .get(`v1/view/player/role/${this.search.role}`, {
          params: this.axiosParams,
        })
        .then((res) => {
          this.players = res.data.players;
          const _players = this.players.filter(
            (c) => c.id === this.selectedPlayer.id
          );
    ...
    getSideStats() {
      axios
        .get(`v1/view/player/${this.selectedPlayer.id}/side`, {
          params: this.axiosParams,
        })
        .then((res) => {
    ...
    getTop3() {
      axios
        .get(`v1/view/player/${this.selectedPlayer.id}/top3`, {
          params: this.axiosParams,
        })
        .then((res) => {
    ...
    getChampionMatches(val) {
      axios
        .get(
          `v1/view/player/${this.selectedPlayer.id}/${this.selectedChampion.champion_id}/all_matches`,
          { params: this.axiosParams }
        )
        .then((res) => {
          this.championsWith = res.data.champions_with;
    ...
    getChampions() {
      axios
        .get(`v1/view/player/${this.selectedPlayer.id}/champions`, {
          params: this.axiosParams,
        })
        .then((res) => {
