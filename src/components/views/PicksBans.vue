        ...
        <v-col cols="12">
          <v-tabs-items v-model="tab">
              ...
              <v-row>
                <v-col cols="6">
                  <v-data-table
                    ...
                    :items="bluePicks"
                    item-key="name"
                    :sort-by="picksBansSortBy"
                    :group-by="picksBansGroupBy"
                    show-group-by
                    :items-per-page="-1"
                    sort-desc
                    hide-default-footer
            ...
            <v-tab-item>
              <v-row>
                <v-col
                  v-for="role in ['baron', 'jungle', 'mid', 'dragon', 'sup']"
                  :key="role"
                >
                  <v-card>
                    ...
                    <v-data-table
                      ...
                      item-key="name"
                      hide-default-footer
                      :sort-by="presenceSortBy"
                      :sort-desc="presenceSortDesc"
                      multi-sort
                      :items-per-page="-1"
                      @update:sort-by="updatePresenceSortBy"
...
export default {
  ...
  methods: {
    ...
    getPresence() {
      axios
        .get(`v1/view/presence`, { params: this.axiosParams })
        .then((res) => {
