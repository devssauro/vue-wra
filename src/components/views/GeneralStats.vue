                    ...
                    >
                      <template v-slot:[`item.champion_name`]="{ item }">
                        <v-avatar
                          rounded
                          size="32"
                          v-if="item.champion_name !== undefined"
                        >
...
export default {
  ...
  computed: {
    axiosParams() {
      ...
      if (this.search.team !== null) params.append("team", this.search.team);
      if (this.search.team !== null) params.append("team", this.search.team);
  ...
  methods: {
    ...
    getTeamStats() {
      axios
        .get(`v1/view/stats/team`, { params: this.axiosParams })
        .then((res) => {
    ...
    getChampionStats() {
      axios
        .get(`v1/view/stats/champion`, { params: this.axiosParams })
        .then((res) => {
    ...
    getPlayerStats() {
      axios
        .get(`v1/view/stats/player`, { params: this.axiosParams })
        .then((res) => {
